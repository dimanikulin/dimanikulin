...
хочу напомнить о некоторых рекомендациях касательно вашей безопасности:
- поставьте где только можно двухфакторную авторизацию, в телеграмме, вайбере и тд
- не открывайте подозрительных ссылок, даже если они присланы со знакомого контакта (контакт могут подменить)
- не ставьте себе непроверенное ПО (из непонятных источников).
- при установке приложений давайте им как можно меньше прав
- Профили в соц. сетях надо максимально урезать по доступам, если они есть и это не критично.
